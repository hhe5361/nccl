...
struct ncclProxySubArgs {
  ...
  uint64_t end;
  int regBufferReady;
  uint8_t phase1WindowCfgLogged;
  uint8_t phase1SendWstall;
  ...
  uint8_t phase6RateCfgLogged;
  uint8_t phase6RateStall;
  double phase6Tokens;
  ...
  uint16_t phase6CtrlWarmupEpochsSeen;
  uint16_t phase6CtrlStableLowCount;
  uint64_t phase6CtrlEpochStartNs;
  uint64_t phase6CtrlEpochSamples;
  uint64_t phase6CtrlEpochDelaySumNs;
  uint64_t phase6CtrlEpochDelayMaxNs;
  uint64_t phase6CtrlEpochBytes;
  uint64_t phase6CtrlEpochPosts;
  uint64_t phase6CtrlEpochWstalls;
  double phase6CtrlW;
  double phase6CtrlBaselineDelayNs;
  double phase6CtrlBaselineGbps;
  double phase6CtrlDelayFastNs;
  double phase6CtrlDelaySlowNs;
  double phase6CtrlThroughputFastGbps;
  double phase6CtrlThroughputSlowGbps;
  double phase6CtrlIntegral;
  uint8_t phase7RateCfgLogged;
  uint8_t phase7RateStall;
  uint8_t phase7ControlActive;
  double phase7Tokens;
  uint64_t phase7LastRefillNs;
  uint64_t phase7ObserveStartNs;
  double phase7ObservedPosts;
