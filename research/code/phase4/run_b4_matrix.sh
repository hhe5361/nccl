...
pairs = {
    ...
    "CFG_TORCH_ENV": run.get("torch_env", "/workspace/venvs/torch-cu132-custom/bin/activate"),
    ...
    "CFG_CONTAINER_NAME": container.get("name", "nccl-cu132-dev"),
...
NCCL_PHASE6_EPOCH_MS=${NCCL_PHASE6_EPOCH_MS:-5}
NCCL_PHASE6_MIN_SAMPLES=${NCCL_PHASE6_MIN_SAMPLES:-4}
NCCL_PHASE6_WARMUP_EPOCHS=${NCCL_PHASE6_WARMUP_EPOCHS:-1}
NCCL_PHASE6_COOLDOWN_EPOCHS=${NCCL_PHASE6_COOLDOWN_EPOCHS:-2}
NCCL_PHASE6_STABLE_EPOCHS=${NCCL_PHASE6_STABLE_EPOCHS:-5}
NCCL_PHASE6_THRESHOLD_HIGH_PCT=${NCCL_PHASE6_THRESHOLD_HIGH_PCT:-100}
NCCL_PHASE6_THRESHOLD_LOW_PCT=${NCCL_PHASE6_THRESHOLD_LOW_PCT:-15}
