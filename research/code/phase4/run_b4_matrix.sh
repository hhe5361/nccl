...
NCCL_PHASE6_COOLDOWN_EPOCHS=${NCCL_PHASE6_COOLDOWN_EPOCHS:-1}
NCCL_PHASE6_STABLE_EPOCHS=${NCCL_PHASE6_STABLE_EPOCHS:-3}
NCCL_PHASE6_THRESHOLD_HIGH_PCT=${NCCL_PHASE6_THRESHOLD_HIGH_PCT:-50}
