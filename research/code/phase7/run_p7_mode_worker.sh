...
echo "[phase7-worker] PHASE7_ENABLE=${NCCL_PHASE7_ENABLE} PHASE7_POST_RATE_RATIO_PCT=${NCCL_PHASE7_POST_RATE_RATIO_PCT} PHASE7_OBSERVE_MS=${NCCL_PHASE7_OBSERVE_MS} PHASE7_BURST_WINDOW_MS=${NCCL_PHASE7_BURST_WINDOW_MS}"
