...
PHASE4_W_VALUE=${PHASE4_W_VALUE:-${NCCL_PHASE4_POST_RECEIVE_W:-4}}
...
case "${MODE}" in
  ...
  phase4)
    ...
    export NCCL_PHASE4_POST_RECEIVE_W="${PHASE4_W_VALUE}"
    ;;
  *)
...
echo "[appendix2-worker] APPENDIX2_GROUP_LOG=${NCCL_APPENDIX2_GROUP_LOG} PHASE4_ENABLE=${NCCL_PHASE4_ENABLE} PHASE4_W=${NCCL_PHASE4_POST_RECEIVE_W} STATUS_FILE=${STATUS_FILE}"
